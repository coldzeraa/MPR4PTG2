    ...
    return (
        ...
        <div className="container-fluid d-flex align-items-center justify-content-center">
            ...
            <div className="content">
                ...
                <p>
                    Beachten Sie bitte folgende Hinweise, um OptiMate optimal nutzen zu können:<br/><br/>
                    <ol>
                        <li><b>Wählen Sie eine ruhige Umgebung für die Untersuchung.</b><br/>Vermeiden Sie Störgeräusche, um das Ergebnis nicht zu verfälschen.</li><br/>
                        <li><b>Starten Sie erst, wenn Sie bereit sind.</b><br/>Durch den Druck auf "Start" wird ein Countdown gestartet, der Ihnen 15 Sekunden Zeit gibt, um Ihr Mobiltelefon in die VR-Vorrichtung einzusetzen.</li><br/>
                        <li><b>Handeln Sie in Ihrem eigenen Interesse.</b><br/>Um ein möglichst aussagekräftiges Ergebnis zu erhalten, sollten Sie nur dann angeben, einen Punkt gesehen zu haben, wenn Sie ihn tatsächlich wahrgenommen haben.</li>
                    </ol>
                </p>
                </div>
                {/*Login Button*/}
